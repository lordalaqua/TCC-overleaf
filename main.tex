...
\textit{Stereo matching} tem uma história, existem extensas taxonomias das técnicas existentes, desde \citet{stereoSurvey2001} que definiu a taxonomia, até \citet{stereoSurvey2016} que faz uma \textit{survey} das técnicas de \textit{stereo} e também das próprias \textit{surveys} anteriores.
