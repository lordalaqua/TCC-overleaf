...
\end{tikzpicture}
    ...
    \legend{Fonte: La https://tex.stackexchange.com/q/96074/}
\end{figure}
...
\section{Estimativa de profundidade}
\citet{Lai1992}, \citet{Saxena2005}, \citet{Saxena2008}, \citet{Liu2010}

\citet{Fayao2015}, \citet{Fayao2016}, \citet{Eigen2014}, \citet{Eigen2015}, \citet{Godard2016}, \citet{Kuznietsov2017}

\citet{Zhou2017}

\subsection{\textit{Stereo Matching}}
taxonomias das técnicas existentes, desde \citet{stereoSurvey2001} que definiu a taxonomia, até \citet{stereoSurvey2016} que faz uma \textit{survey} das técnicas de \textit{stereo} e também das próprias \textit{surveys} anteriores.
