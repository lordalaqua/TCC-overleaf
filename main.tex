...
Stereo matching pode ser usado para imagens omnidirecionais, já usam em colagens (citar

\begin{itemize}
    \item \emph{cite}: Unicórnios são verdes \cite{Li2001};
     \item \emph{citep}:Unicórnios são verdes \citep{Li2001};
     \item \emph{citet}: Segundo \citet{Li2001}, unicórnios são
     verdes.
     \item \emph{citen or citenum}: Segundo \citen{Li2001},
     unicórnios são verdes.
     \item \emph{citeauthor e citeyearpar}: Segundo artigos de
     \citeauthor{Li2001} , unicórnios são verdes
     \citeyearpar{Li2001}.
\end{itemize}
